            ...
            <div className={`${isDarkMode ? 'bg-[#2a1052]/80' : 'bg-purple-50/80'} p-1.5 sm:p-3 md:p-4 rounded-lg sm:rounded-xl md:rounded-2xl border ${isDarkMode ? 'border-purple-500/30' : 'border-purple-200'} backdrop-blur-sm flex flex-col relative`}>
              <div className="flex items-start justify-between mb-1 sm:mb-2 md:mb-3">
                ...
                <div className="text-right">
                  <p className={`text-xs sm:text-sm md:text-base font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>Free Plan</p>
                  <p className={`text-xs sm:text-sm md:text-base font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>$0</p>
                </div>
              </div>
          ...
          <li className="flex items-center space-x-1 sm:space-x-2 md:space-x-3">
            ...
            <div className={`${isDarkMode ? 'bg-[#2a1052]/80' : 'bg-purple-50/80'} p-1.5 sm:p-3 md:p-4 rounded-lg sm:rounded-xl md:rounded-2xl border ${isDarkMode ? 'border-purple-500/30' : 'border-purple-200'} backdrop-blur-sm flex flex-col relative`}>
              <div className="flex items-start justify-between mb-1 sm:mb-2 md:mb-3">
                ...
                <div className="text-right">
                  <p className={`text-xs sm:text-sm md:text-base font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>Gold Plan</p>
                  <p className={`text-xs sm:text-sm md:text-base font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>{formatPrice(goldPlan.price)}/mo</p>
                </div>
              </div>
              <ul className={`space-y-0.5 sm:space-y-1.5 md:space-y-2 ${themeClasses.textSecondary} flex-1 text-xs sm:text-xs md:text-sm`}>
          <li className="flex items-center space-x-1 sm:space-x-2 md:space-x-3">
          ...
          <li className="flex items-center space-x-1 sm:space-x-2 md:space-x-3">
            ...
            <div className={`${isDarkMode ? 'bg-[#2a1052]/80' : 'bg-purple-50/80'} p-1.5 sm:p-3 md:p-4 rounded-lg sm:rounded-xl md:rounded-2xl border ${isDarkMode ? 'border-purple-500/30' : 'border-purple-200'} backdrop-blur-sm flex flex-col relative`}>
              <div className="flex items-start justify-between mb-1 sm:mb-2 md:mb-3">
                ...
                <div className="text-right">
                  <p className={`text-xs sm:text-sm md:text-base font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>Diamond Plan</p>
                  <p className={`text-xs sm:text-sm md:text-base font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>{formatPrice(diamondPlan.price)}/mo</p>
                </div>
              </div>
              <ul className={`space-y-0.5 sm:space-y-1.5 md:space-y-2 ${themeClasses.textSecondary} flex-1 text-xs sm:text-xs md:text-sm`}>
          <li className="flex items-center space-x-1 sm:space-x-2 md:space-x-3">
